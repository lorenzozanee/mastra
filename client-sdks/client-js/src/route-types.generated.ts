...
type Shared_Auxiliary_643 =
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_643[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_643;
    }
  | {
      traces:
        | {
            some: Shared_Auxiliary_591;
          }
        | {
            none: Shared_Auxiliary_591;
          };
    };

type Shared_Auxiliary_1165 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1165[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1165;
    };

type Shared_Auxiliary_1305 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1305[] | undefined;
};
...
type Shared_Type_111 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_106;
  predicates: Shared_Auxiliary_1165[];
};
...
type Shared_Type_112 = {
  ...
  predicate: Shared_Auxiliary_1165;
};
...
type Shared_Type_126 = {
  ...
  files?: Shared_Auxiliary_1305[] | undefined;
...
export type PostObservabilityThreadsQuery_Body = {
  ...
  where?: Shared_Auxiliary_643 | undefined;
  page: {
    limit: number;
    after?: (string | null) | undefined;
  };
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1305[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
